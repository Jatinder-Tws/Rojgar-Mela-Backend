...
class User(Base):
    ...
    # Login tracking / lockout (social-login PRD)
    last_login_method = Column(String(32), nullable=True)
    ...
    credit_account = relationship(
        "UserCreditAccount", uselist=False, back_populates="user", cascade="all, delete-orphan"
    )
