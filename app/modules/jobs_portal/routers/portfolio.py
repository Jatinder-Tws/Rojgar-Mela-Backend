...
from app.core.dependencies import require_verified, require_seeker, require_provider
from app.modules.jobs_portal.controllers.portfolio_controller import (
