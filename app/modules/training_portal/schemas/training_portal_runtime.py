...
class PortalEnrollmentCreate(BaseModel):
    ...
    payment_status: Literal["paid_online", "paid_offline", "pending", "free", "overdue", "refunded", "initiated", "token_paid"] = "pending"
    payment_mode: Optional[str] = None
    total_fee: float = 0
    paid_amount: float = 0
    balance_due: float = 0
...
class PortalEnrollmentUpdate(BaseModel):
    ...
    payment_status: Optional[Literal["paid_online", "paid_offline", "pending", "free", "overdue", "refunded", "initiated", "token_paid"]] = None
    payment_mode: Optional[str] = None
    ...
    notes: Optional[str] = None
    status: Optional[Literal["active", "completed", "dropped", "pending", "token_booked"]] = None
...
class PortalEnrollmentOut(BaseModel):
    ...
    venue_visit_deadline: Optional[datetime] = None
...
class PortalPaymentOrderCreate(BaseModel):
    ...
    payment_purpose: Literal["token", "balance", "full"] = "full"
